	...
	var TasksApp = React.createClass({
	    ...
	    handleSubmit: function (e) {
	        ...
	        $.ajax({
	            ...
	            success: ReactDOM.render(React.createElement(TasksApp, { url: '/api/tasks/' }), document.getElementById('container'))
	        });
	    },
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'p',
	                    null,
	                    React.createElement('textarea', { onChange: this.handleDescriptionChange, value: this.state.description,
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'select',
	                        { value: 'Back Burner', onChange: this.handleStatusChange,
	                            placeholder: 'Status' },
	                        React.createElement(
	                            'option',
	                            { value: 'Back Burner' },
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'select',
	                        { value: 'Glacial', onChange: this.handlePriorityChange,
