...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function($) {// require("bootstrap.min.css");
	...
	var TasksApp = React.createClass({
	    ...
	    handlePriorityChange: function (e) {
	        this.setState({ priority: e.target.priority });
	    },
	    ...
	    render: function () {
	        return React.createElement(
	            ...
	            React.createElement(TasksList, { url: '/api/tasks/' }),
	            React.createElement(
	                'form',
	                ...
	                React.createElement(
	                    'p',
	                    null,
	                    React.createElement('input', { onChange: this.handleTitleChange, value: this.state.title,
	                        type: 'text', placeholder: 'Title' })
	                ),
	                React.createElement(
	                    'p',
	                    null,
	                    React.createElement('input', { onChange: this.handleDescriptionChange, value: this.state.description,
	                        type: 'text', placeholder: 'Description' })
	                ),
	                React.createElement(
	                    'p',
	                    null,
	                    React.createElement('input', { onChange: this.handleStatusChange, value: this.state.status,
	                        type: 'text', placeholder: 'Status' })
	                ),
	                React.createElement(
	                    'p',
	                    null,
	                    React.createElement('input', { onChange: this.handlePriorityChange, value: this.state.priority,
	...
	ReactDOM.render(React.createElement(TasksApp, { url: '/api/tasks/' }), document.getElementById('container'));
	// pollInterval={5000}
